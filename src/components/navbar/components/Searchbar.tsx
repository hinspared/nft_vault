  ...
  return (
    ...
    >
      ...
      <div className="flex w-full items-center rounded-xl border-2 border-slate-400 px-3">
        ...
        <input
          type="search"
          className="h-10 w-full border-0 border-transparent px-2 pl-1 pl-0 text-slate-900 outline-0 placeholder:text-[#8a939b] focus:border-0 focus:border-transparent focus:outline-0"
